...
const ServicesSection = () => {
  ...
  const services = [
    {
      ...
      description:
        "24-72 hour delivery in major cities with 4-6 hour express options in Dhaka. Real-time tracking included.",
      icon: <FaShippingFast />,
    ...
    },
    {
      ...
      description:
        "48-72 hour delivery across all districts with specialized rural area solutions.",
      icon: <FaMapMarkerAlt />,
    ...
    },
    {
      title: "Fulfillment",
      description:
        "End-to-end logistics including inventory management and custom packaging.",
      icon: <FaBoxOpen />,
    ...
    },
    {
      ...
      description:
        "Secure cash collection with instant remittance and fraud protection.",
    ...
    },
    {
      ...
      description:
        "Enterprise solutions with warehouse management and API integration.",
      icon: <FaBuilding />,
    ...
    },
    {
      title: "Returns",
      description:
        "Automated return processing with quality checks and restocking.",
      icon: <FaExchangeAlt />,
  ...
  return (
    <motion.div
      className="relative bg-gradient-to-br rounded-4xl from-[#013B3A] to-[#025C5A] py-24 px-4 overflow-hidden"
      initial="hidden"
      whileInView="visible"
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            ...
            >
              <div
                className={`h-full bg-gradient-to-br ${service.color} rounded-xl p-8 shadow-lg cursor-pointer transition-all duration-300`}
                ...
                <AnimatePresence>
                  {hoveredIndex === index ? (
                    ...
                    <motion.div
                      ...
                      exit={{ opacity: 0 }}
                    >
                      <div className="text-sm text-teal-600 font-medium mt-4">Learn more</div>
                    </motion.div>
                  )}
                </AnimatePresence>
              </div>
