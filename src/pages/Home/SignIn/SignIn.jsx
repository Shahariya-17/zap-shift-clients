  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-teal-50 via-white to-lime-50 flex items-center justify-center px-4 py-8 overflow-hidden">
      ...
      >
        ...
        {/* Right - Branding */}
        <div className="hidden lg:flex flex-col items-center justify-center bg-gradient-to-br from-teal-500 to-lime-500 relative overflow-hidden">
          ...
          >
            ...
            <motion.p 
              className="text-xl leading-relaxed mb-8 font-light text-white/90"
              animate={{
                opacity: [0.8, 1, 0.8]
              }}
              transition={{
            ...
            >
              Fastest Delivery System in Your City
            </motion.p>
